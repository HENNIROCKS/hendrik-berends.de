/**
 * Registers Panel icons that Kirby's own sprite does not ship.
 *
 * The path data comes from Remix Icon 4.6.0 (Apache-2.0,
 * icons/Editor/carousel-view.svg). Remix uses the same 24x24 viewBox as
 * Kirby's icon sprite, so the path can be used verbatim.
 */
window.panel.plugin("hnnrcks/site", {
  icons: {
    "carousel-view":
